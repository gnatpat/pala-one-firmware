#ifndef PALA_UI_IDLE_PAGINATOR_H
#define PALA_UI_IDLE_PAGINATOR_H

#include <Arduino.h>

// ============================================================================
//  IdlePaginator — background pre-pagination of the most-recently-opened
//  book's on-disk page-offset cache.
//
...
//  book. This module fills the cache in the background so re-opening is fast.
//
...
#endif  // PALA_UI_IDLE_PAGINATOR_H
