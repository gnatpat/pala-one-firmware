...
bool openBookByIndex(int idx) {
  ...
  // Tell the background paginator which book to pre-paginate the next
  // time the user changes a layout-affecting setting from the web UI.
  BackgroundPaginator::saveLastOpenedBook(path);
